export const mockStations = [
  { 
    ...
    dataFreshnessLabel: 'hace 1 min', issueHint: null, isFavorite: true, status: 'OPERATIONAL', fallbackStationId: null
  },
  { 
    ...
    dataFreshnessLabel: 'hace 2 min', issueHint: null, isFavorite: false, status: 'OPERATIONAL', fallbackStationId: null
  },
  { 
    ...
    dataFreshnessLabel: 'hace 6 min', issueHint: null, isFavorite: false, status: 'OPERATIONAL', fallbackStationId: null
  },
  { 
    ...
    dataFreshnessLabel: 'hace 12 min', issueHint: 'Mantenimiento programado.', isFavorite: false, status: 'BROKEN', fallbackStationId: 'st_1'
  }
];
